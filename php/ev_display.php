...
$imageresult1 = mysql_query($sqlimage);
 ...
 echo "<table>";
  echo "<tr> <th>ID</th> <th>EVENT NAME</th> <th>ADDED BY</th> <th>EVENT TYPE</th> <th>REFERRED BY</th> <th>DESCRIPTION</th> <th>IMAGE</th>";
  if 
  ...
  while($rows=mysql_fetch_assoc($imageresult1))
   ...
   $description = substr($description, 0, 120); 
    ...
    echo '<td>' . $ev_name . '</td>';
    echo '<td>' . $username . '</td>';
    echo '<td>' . $description . '<br><a href="ev_details.php?value='.$con_id.'">See full description</a></td>';
